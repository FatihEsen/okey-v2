...
import { GameState, GameMode, GamePhase, Player } from '../src/types.js';
import { createDeck, shuffle, determineOkey, sortByPairs, sortBySets } from '../src/logic/okeyEngine.js';
  ...
  socket.on('startGame', (roomId) => {
    ...
    if (room && room.players.length > 0) {
      ...
      room.gameState = {
        ...
        indicator,
        okeyTile,
        phase: GamePhase.PLAYING, // Player 0 has 22 tiles, must discard one — same as offline mode
        lastOpeningScore: 0,
        lastOpeningPairs: 0,
        currentOpenScore: 0,
        currentOpenPairs: 0,
