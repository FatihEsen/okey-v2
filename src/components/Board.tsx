    ...
    >
      {tiles.map((t, i) => (
        ...
        >
          ...
          {i === 0 && type === "set" && (
            <div className="absolute -left-1 top-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full bg-blue-400/0 group-hover:bg-blue-400/60 transition-all pointer-events-none" />
          )}
        </div>
      ))}
